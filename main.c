...
void page1() {
  ...
  glColor3f(0.71f, 0.41f, 0.41f);

  Write(-1.5, 2.5, 0.0, 0.006, "    ATRIA INSTITUTE OF TECHNOLOGY");

  glColor3f(0.23f, 0.23f, 0.21f);
  glLineWidth(2.0);
...
void page5() {
  ...
  Write(-4.3, 1.4, 0.1, 0.008, " path to put a packet on to get to its destination. It stores in its routing table the distancefor each network it knows");
...
void anim() {
 finish = 1;
 float i, temp = 0.2;
 for (i = 3; i < 17; i = i + temp) // packetsfrom router 4 to 3
  {
 ...
 for (i = 3; i < 18; i = i + temp) // packetsfrom router 4 to 1
  {
 ...
 for (i = 13; i > 1; i = i - temp) //packetsfrom router 3 to 2
  {
 ...
 for (i = 0; i < 12; i = i + temp) //packetsfrom router 1 to 2
  {
 ...
 for (i = 1; i < 14; i = i + temp) //packetsfrom router 2 to 3
  {
 ...
 for (i = 14; i > 1; i = i - temp) //packetsfrom router 2 to 1
  {
    glColor3f(0.917647, 0.560784, 0.560784);
    glBegin(GL_QUADS);
    glVertex2i(-20 + i, 1);
 ...
 for (i = 4; i < 18; i = i + temp) // packetsfrom router 1 to 4
  {
    glColor3f(0.196078, 0.6, 0.8);
    glBegin(GL_QUADS);
    glVertex2i(-23 + i, 1 + i);
 ...
 for (i = 4; i < 17; i = i + temp) // packetsfrom router 3 to 4
  {
    glColor3f(0.917647, 0.560784, 0.560784);
    glBegin(GL_QUADS);
    glVertex2i(22 - i, 1 + i);
